...
- **Tighter scale ratio.** 1.125â€“1.2 between steps is typical. More type elements here than on brand surfaces; exaggerated contrast creates noise.
- **Line length still applies for prose** (65â€“75ch). Data and compact UI can run denser; tables at 120ch+ are fine.
...
- 150â€“250 ms on most transitions. Users are in flow; don't make them wait for choreography.
