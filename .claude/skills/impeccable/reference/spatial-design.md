...
Create semantic z-index scales (dropdown â†’ sticky â†’ modal-backdrop â†’ modal â†’ toast â†’ tooltip) instead of arbitrary numbers. For shadows, create a consistent elevation scale (sm â†’ md â†’ lg â†’ xl). **Key insight**: Shadows should be subtle. If you can clearly see it, it's probably too strong.
