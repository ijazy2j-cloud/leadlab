...
// â”€â”€â”€ Section 1: Constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const ANTIPATTERNS = [
  // â”€â”€ AI slop: tells that something was AI-generated â”€â”€
  {
    id: 'side-tab',
    category: 'slop',
    name: 'Side-tab accent border',
    description:
      'Thick colored border on one side of a card â€” the most recognizable tell of AI-generated UIs. Use a subtler accent or remove it entirely.',
  ...
  },
  {
    ...
    description:
      'Thick accent border on a rounded card â€” the border clashes with the rounded corners. Remove the border or the border-radius.',
    skillSection: 'Visual Details',
    skillGuideline: 'colored accent stripe',
  },
  {
  ...
  },
  {
    ...
    description:
      'Font sizes are too close together â€” no clear visual hierarchy. Use fewer sizes with more contrast (aim for at least a 1.25 ratio between steps).',
    skillSection: 'Typography',
  ...
  },
  {
    ...
    name: 'Gradient text',
    description:
      'Gradient text is decorative rather than meaningful â€” a common AI tell, especially on headings and metrics. Use solid colors for text.',
  ...
  },
  {
    ...
    name: 'Nested cards',
    description:
      'Cards inside cards create visual noise and excessive depth. Flatten the hierarchy â€” use spacing, typography, and dividers instead of nesting containers.',
  ...
  },
  {
    ...
    description:
      'The same spacing value used everywhere â€” no rhythm, no variation. Use tight groupings for related items and generous separations between sections.',
    skillSection: 'Layout & Space',
  ...
  },
  {
    ...
    description:
      'Bounce and elastic easing feel dated and tacky. Real objects decelerate smoothly â€” use exponential easing (ease-out-quart/quint/expo) instead.',
    skillSection: 'Motion',
  ...
  },
  {
    ...
    description:
      'Dark backgrounds with colored box-shadow glows are the default "cool" look of AI-generated UIs. Use subtle, purposeful lighting instead â€” or skip the dark theme entirely.',
    skillSection: 'Color & Contrast',
  ...
  },
  {
    ...
    description:
      'A small rounded-square icon container above a heading is the universal AI feature-card template â€” every generator outputs this exact shape. Try a side-by-side icon and heading, or let the icon sit in flow without its own container.',
    skillSection: 'Typography',
  ...
  },
  {
    ...
    description:
      'A tiny uppercase letter-spaced label sitting immediately above an oversized hero headline â€” or the same shape rendered as a pill chip â€” is now the default AI SaaS hero. Drop the eyebrow, integrate the kicker into the headline, or run it as a navigation breadcrumb instead.',
    skillSection: 'Typography',
  ...
  // â”€â”€ Quality: general design and accessibility issues â”€â”€
  {
    id: 'pure-black-white',
    category: 'quality',
...
// â”€â”€â”€ Section 2: Color Utilities â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

function isNeutralColor(color) {
  if (!color || color === 'transparent') return true;

  // rgb/rgba â€” use channel spread. Threshold 30 â‰ˆ 11.7% of the 0â€“255 range.
  const rgb = color.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);
  if (rgb) {
    return (Math.max(+rgb[1], +rgb[2], +rgb[3]) - Math.min(+rgb[1], +rgb[2], +rgb[3])) < 30;
  }

  // oklch()/lch() â€” chroma is the second numeric component.
  // oklch chroma is ~0â€“0.4 in sRGB gamut; >= 0.02 reads as tinted, not gray.
  // lch chroma is ~0â€“150; >= 3 reads as tinted. jsdom emits both formats
  ...
  // oklab()/lab() â€” a and b are signed axes; chroma = sqrt(aÂ² + bÂ²).
  ...
  // hsl/hsla â€” saturation is the second numeric component (percent).
  ...
  // hwb(hue whiteness% blackness%) â€” a pixel is fully gray when
  ...
  // Unknown / unrecognized format â€” err on the side of DETECTING rather
...
// â”€â”€â”€ Section 3: Pure Detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function checkColors(opts) {
  ...
  if (SAFE_TAGS.has(tag)) {
    ...
    // its own opaque background and direct text, it is a styled button â€” and
  ...
  if (hasDirectText && textColor && !isEmojiOnly) {
    ...
    if (bgs) {
      // Gray on colored background â€” flag if every stop is chromatic
      ...
      // Low contrast (WCAG AA) â€” worst case across all bg stops
      ...
      if (ratio < threshold) {
        ...
        // gradient is invisible to us â€” we end up measuring contrast
        ...
        if (!isAlphaFallbackFP) {
          findings.push({ id: 'low-contrast', snippet: `${ratio.toFixed(1)}:1 (need ${threshold}:1) â€” text ${colorToHex(textColor)} on ${colorToHex(bgs[worstIdx])}` });
        }
      }
    }
...
//   â€¢ size 32â€“128px on both axes (not too small, not a hero image)
//   â€¢ aspect ratio 0.7â€“1.4 (squarish â€” excludes wide thumbnails / pill badges)
//   â€¢ has a non-transparent background-color, background-image, OR a visible border
//     (covers solid colors, white-with-border, gradients â€” anything that visually
//      defines a tile)
//   â€¢ border-radius < width/2 (excludes round avatars; rounded squares pass)
//   â€¢ contains an <svg> or icon-class <i> element that's smaller than the tile
//   â€¢ the tile sits above the heading (its bottom is above the heading's top)
function checkIconTile(opts) {
  ...
  // Size window: 32â€“128px on each axis
  ...
  // (Allow the check to skip when both top/bottom are 0 â€” jsdom layout case.)
...
//   1. Primary face is in KNOWN_SERIF_FONTS â†’ serif.
//   2. Primary face is unknown but the stack ends in the generic `serif`
//      token â†’ treat as serif. Authors who declare `font-family: 'X', serif`
...
function checkItalicSerif(opts) {
  ...
  // h2 â‰¥ 48px catches the cases where the design demotes the visual hero
...
// chroma â€” i.e., it's an "accent color" rather than near-neutral.
...
function isAccentColor(cssColor) {
  ...
  // rgb / rgba â€” direct channel-distance check.
  ...
  // oklch(L C H) â€” chroma C is what matters. Typical neutral grays
  ...
  // hsl(H, S%, L%) â€” saturation > 20% reads as accent.
...
function checkHeroEyebrow(opts) {
  ...
  // jsdom can resolve â€” the computed value comes back as "2em" or
  ...
  // Branch B: modern accent-bold eyebrow â€” sentence case, low
...
function checkGlow(opts) {
  ...
  for (const shadow of parts) {
    ...
    // Extract px values â€” in computed style: "color Xpx Ypx BLURpx [SPREADpx]"
...
// â”€â”€â”€ Section 4: resolveBackground (unified) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function resolveBackground(el, win, customPropMap) {
  ...
  while (current && current.nodeType === 1) {
    ...
    //   â€¢ on body/html: assume white. Body-level gradients are almost
    //     always decorative texture (paper grain, noise) on top of a
    //     solid bg-color the page set via `background: var(--paper)`
    //     shorthand â€” which jsdom can't decompose into bg-color. The
    ...
    //   â€¢ on other elements: bail to null and let the caller fall back
...
function resolveGradientStops(el, win) {
  ...
  while (current && current.nodeType === 1) {
    ...
    if (!DETECTOR_IS_BROWSER) {
      // jsdom doesn't decompose `background:` shorthand â€” peek at the raw inline style
      const rawStyle = current.getAttribute?.('style') || '';
...
// â”€â”€â”€ Section 5: Element Adapters â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// Browser adapters â€” call getComputedStyle/getBoundingClientRect on live DOM
...
function checkElementColorsDOM(el) {
  const tag = el.tagName.toLowerCase();
  // No early SAFE_TAGS bail here â€” checkColors() does its own gating that
...
// builds â€” the values come back as literal "var(--font-weight-bold)"
...
// OKLCH â†’ sRGB conversion (BjÃ¶rn Ottosson's matrices). L in 0..1 (or %),
// C in 0..~0.4 typical, H in degrees. Returns clamped {r,g,b,a:1} in 0..255.
// Needed because jsdom doesn't compute oklch() values â€” getComputedStyle
...
function checkElementGlowDOM(el) {
  ...
  // Use parent's background â€” glow radiates outward, so the surrounding context matters
  ...
  if (!parentBg) {
    // Gradient background â€” sample its colors to determine if it's dark
...
// specified value verbatim â€” so for the Node path we walk parents ourselves.
function resolveFontSizePx(el, win) {
  const chain = []; // raw font-size strings, leaf â†’ root
  let cur = el;
  while (cur && cur.nodeType === 1) {
  ...
  // Walk root â†’ leaf, resolving each value relative to its parent context.
  ...
  for (let i = chain.length - 1; i >= 0; i--) {
    ...
    else px = num; // unitless â€” already resolved
  }
  return px;
}
...
// element rect dimensions, which jsdom can't compute â€” pass `rect: null` from
...
function checkQuality(opts) {
  ...
  // font-size â€” bigger text demands proportionally more padding.
  //   vertical:   max(4px, fontSize Ã— 0.3)
  //   horizontal: max(8px, fontSize Ã— 0.5)
  if (rect && hasDirectText && textLen > 20 && rect.width > 100 && rect.height > 30) {
    ...
    if (borderCount >= 2 || hasBg) {
      ...
      // Emit at most one finding per element â€” pick whichever axis is worse.
      if (vMin < vThresh) {
        findings.push({ id: 'cramped-padding', snippet: `${vMin}px vertical padding (need â‰¥${vThresh.toFixed(1)}px for ${fontSize}px text)` });
      } else if (hMin < hThresh) {
        findings.push({ id: 'cramped-padding', snippet: `${hMin}px horizontal padding (need â‰¥${hThresh.toFixed(1)}px for ${fontSize}px text)` });
      }
    }
  }
  ...
  // with NO container providing horizontal padding â€” text bleeds
...
function checkElementQualityDOM(el) {
  ...
  // Browser getComputedStyle resolves everything to px â€” direct parseFloat
  // works.
...
// Node adapters â€” take pre-extracted jsdom computed style

// jsdom doesn't lay out OR resolve em/rem/% to px â€” so we pre-resolve every
...
function checkElementColors(el, style, tag, window, customPropMap, hasAnchorInheritRule) {
  ...
  // browsers (Chrome's UA wraps :link in :where() â€” zero specificity).
...
function checkElementIconTile(el, tag, window) {
  ...
  // jsdom doesn't lay out â€” read explicit pixel dimensions from CSS instead.
...
// â”€â”€â”€ Section 6: Page-Level Checks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// Browser page-level checks â€” use document/getComputedStyle globals

function checkTypography() {
  const findings = [];

  // Walk actual text-bearing elements and tally font usage by *computed style*.
  // This is much more accurate than scanning CSS rules â€” it ignores rules that
  ...
  const fontUsage = new Map(); // primary font name â†’ count of elements
...
// Node page-level checks â€” take document/window as parameters
...
// â”€â”€â”€ Section 7: Browser UI (IS_BROWSER only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
if (IS_BROWSER) {
  ...
  const highlight = function(el, findings) {
    ...
    // Build per-finding label entries: âœ¦ prefix for slop
  ...
  function generateSelector(el) {
    ...
    while (current && current !== document.body && current !== document.documentElement && depth < MAX_DEPTH) {
      ...
      } catch { /* invalid selector â€” keep walking */ }
